...
class RecommendationAgent:
    ...
    def process(self, state: Dict[str, Any]) -> List[str]:
        ...
        try:
            ...
            3. Получи из базы данных все теги и выбери подходящие под запрос пользователя.
            4. Получи из базы данных все ингредиенты и выбери подходящие под запрос пользователя.
            5. Сформируй правильный SQL-запрос.
            6. Если в метаданных присутствуют теги(tags) - обязательно сделай фильтр: все теги должны присутствовать в итоговых блюдах.
